...
## Project Goal
The overall goal was to get an idea of what an end-to-end machine learning project is and to become comfortable using scikit-learn's API.

## Project Takeaways
- Learned how to make a data pipeline, using it to be able to test various models.
- Learned about using grid search and randomized search for hyperparameter tuning
- Learned the importance of thoroughly planning out the pre-training part of the project, since having to go back to retrain the model can cost you time.
